...
| Component loading | Artifact materialization and compilation in `src/runtime/supervisor.ts`; prepared cache in `crates/runtime-core/src/node.rs` | Guest-accessible loader with delegated grants |
