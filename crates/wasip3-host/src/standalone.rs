...
use wasmplane_runtime_core::server::HttpServer;
use wasmplane_runtime_core::service::{ResidentService, ServiceOptions};
use wasmplane_runtime_core::{config::RuntimeConfig, engine, runtime::Runtime};
...
async fn run() -> Result<i32> {
    ...
    if command == "--help" {
        ...
        println!("wasmplane build|start|dev <app.json>");
        println!(
