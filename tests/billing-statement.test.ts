...
test("project billing rates parse invoice price card from environment", () => {
  assert.deepEqual(projectBillingRatesFromEnv({
    ODENCTL_BILLING_INVOCATION_PER_MILLION_USD: "0.40",
    ODENCTL_BILLING_CPU_MS_PER_MILLION_USD: "0.20",
    ODENCTL_BILLING_WALL_MS_PER_MILLION_USD: "0.10",
    ODENCTL_BILLING_MEMORY_MB_MS_PER_MILLION_USD: "0.05",
    ODENCTL_BILLING_EGRESS_GB_USD: "0.09",
    ODENCTL_BILLING_STORAGE_GB_MONTH_USD: "0.03",
    ODENCTL_BILLING_SQLITE_UNIT_USD: "2.50",
  }), {
