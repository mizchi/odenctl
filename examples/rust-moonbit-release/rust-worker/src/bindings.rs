...
pub mod myedge {
  ...
  #[allow(unused_unsafe, clippy::all)]
  #[allow(async_fn_in_trait)]
  pub fn new_outgoing_body() -> OutgoingBody{
    unsafe {

      #[cfg(target_arch = "wasm32")]
      #[link(wasm_import_module = "myedge:runtime/http@0.1.0")]
      unsafe extern "C" {
        #[link_name = "new-outgoing-body"]
        fn wit_import0() -> i32;
      }
      ...
      let ret = wit_import0();
      OutgoingBody::from_handle(ret as u32)
    }
  }
...
pub mod kv {
  ...
  #[allow(unused_unsafe, clippy::all)]
  #[allow(async_fn_in_trait)]
  pub fn open_namespace(binding: &str,) -> Option<Namespace>{
    unsafe {
      ...
      let result5 = match l3 {
        ...
        1 => {
          let e = {
            ...
            Namespace::from_handle(l4 as u32)
          };
          Some(e)
        }
        _ => _rt::invalid_enum_discriminant(),
...
pub mod secrets {
  ...
  #[allow(unused_unsafe, clippy::all)]
  #[allow(async_fn_in_trait)]
  pub fn open_secret(binding: &str,) -> Option<Secret>{
    unsafe {
...
pub mod durable {
  ...
  #[allow(unused_unsafe, clippy::all)]
  #[allow(async_fn_in_trait)]
  pub fn open_object(binding: &str,name: &str,) -> Option<Object>{
    unsafe {
...
pub mod service {
  ...
  use super::super::super::_rt;
  pub type Request = super::super::super::myedge::runtime::outbound::Request;
  pub type Response = super::super::super::myedge::runtime::outbound::Response;
  #[allow(unused_unsafe, clippy::all)]
  #[allow(async_fn_in_trait)]
  pub async fn fetch(binding: _rt::String,req: Request,) -> Response{
    unsafe {
      ...
      *mut u8, 
      ...
      unsafe impl<'a> _Subtask for _MySubtask<'a> {
        ...
        type Params = (_rt::String, Request, );
        type Results = Response;
        type ParamsLower = ParamsLower;
        fn abi_layout(&mut self) -> ::core::alloc::Layout {
          unsafe {
            ::core::alloc::Layout::from_size_align_unchecked((15*::core::mem::size_of::<*const u8>()), ::core::mem::size_of::<*const u8>())
          }
        }
        
        fn results_offset(&mut self) -> usize { (10*::core::mem::size_of::<*const u8>()) }

        unsafe fn call_import(&mut self, _params: Self::ParamsLower, _results: *mut u8) -> u32 {
          
          #[cfg(target_arch = "wasm32")]
          #[link(wasm_import_module = "myedge:runtime/service@0.1.0")]
          unsafe extern "C" {
            #[link_name = "[async-lower]fetch"]
            fn call(_: *mut u8, _: *mut u8, ) -> i32;
          }
        ...
        unsafe fn params_dealloc_lists(&mut self, _params: Self::ParamsLower) {
          ...
          let l6 = *_params.0.add(6*::core::mem::size_of::<*const u8>()).cast::<*mut u8>();
          let l7 = *_params.0.add(7*::core::mem::size_of::<*const u8>()).cast::<usize>();
          let base12 = l6;
          let len12 = l7;
          for i in 0..len12 {
          ...
          let l13 = *_params.0.add(8*::core::mem::size_of::<*const u8>()).cast::<*mut u8>();
          let l14 = *_params.0.add(9*::core::mem::size_of::<*const u8>()).cast::<usize>();
          let base15 = l13;
          let len15 = l14;
    ...
    unsafe { let super::super::super::myedge::runtime::outbound::Request{ method:method0, uri:uri0, headers:headers0, body:body0, } = _lower1;
    let vec1 = (method0.into_bytes()).into_boxed_slice();
    let ptr1 = vec1.as_ptr().cast::<u8>();
    let len1 = vec1.len();
    ::core::mem::forget(vec1);
...
unsafe fn results_lift(&mut self, _ptr: *mut u8) -> Self::Results {
  ...
  super::super::super::myedge::runtime::outbound::Response{
    status: l0 as u16,
    headers: result9,
    body: <_ as From<_rt::Vec<_>>>::from(_rt::Vec::from_raw_parts(l10.cast(), len12, len12)),
  } }
...
_MySubtask { _unused: core::marker::PhantomData }.call((binding, req,)).await
}
}
...
pub mod bridge {
  ...
  pub fn ping(value: u32,) -> u32{
    unsafe {
      ...
      #[cfg(target_arch = "wasm32")]
      #[link(wasm_import_module = "myedge:runtime/bridge@0.1.0")]
      unsafe extern "C" {
        #[link_name = "ping"]
...
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 1676] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\x8f\x0c\x01A\x02\x01\
A\x1d\x01B\x07\x01r\x02\x04names\x05values\x04\0\x06header\x03\0\0\x01p\x01\x01r\
...
1.0\x05\x08\x02\x03\0\x05\x07request\x02\x03\0\x05\x08response\x01B\x06\x02\x03\x02\
\x01\x09\x04\0\x07request\x03\0\0\x02\x03\x02\x01\x0a\x04\0\x08response\x03\0\x02\
\x01C\x02\x07bindings\x03req\x01\0\x03\x04\0\x05fetch\x01\x04\x03\0\x1cmyedge:ru\
ntime/service@0.1.0\x05\x0b\x01B\x04\x01@\x01\x07messages\x01\0\x04\0\x04info\x01\
\0\x04\0\x04warn\x01\0\x04\0\x05error\x01\0\x03\0\x18myedge:runtime/log@0.1.0\x05\
\x0c\x01B\x02\x01@\x01\x05valuey\0y\x04\0\x04ping\x01\0\x03\0\x1bmyedge:runtime/\
bridge@0.1.0\x05\x0d\x02\x03\0\x01\x07request\x03\0\x07request\x03\0\x0e\x02\x03\
\0\x01\x08response\x03\0\x08response\x03\0\x10\x01C\x01\x03req\x0f\0\x11\x04\0\x06\
handle\x01\x12\x04\0\x1bmyedge:runtime/worker@0.1.0\x04\0\x0b\x0c\x01\0\x06worke\
r\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\x0dwit-component\x070.244.0\x10\
